                        ...
                        <div class="block-slideshow__body">
                            <div class="owl-carousel owl-loaded owl-drag">
                                <div class="owl-stage-outer">
                                    <div class="owl-stage" style="transform: translate3d(-1680px, 0px, 0px); transition: all 0s ease 0s; width: 5880px;">
                                        <div class="owl-item cloned" style="width: 840px;">
                                        ...
                                        <div class="owl-item active" style="width: 840px;">
                                            <a class="block-slideshow__slide" href="#">
                                                <div class="block-slideshow__slide-image block-slideshow__slide-image--desktop" style="background-image: url('/images/slides/slide-3.jpg')"></div>
                                                <div class="block-slideshow__slide-image block-slideshow__slide-image--mobile" style="background-image: url('https://nextshop.pro/wa-data/public/shop/products/29/91/9129/images/24158/24158.440.jpg')"></div>
                                                <div class="block-slideshow__slide-content">
                                                    <div class="block-slideshow__slide-title">
                                                        Лучшие мастера по ремонту</div>
                                                    <div class="block-slideshow__slide-text">Фото приведено для иллюстрации формы и размеров и может иметь незначительные отличия во внешнем виде (надписи, логотипы, наклейки) от реального товара..</div>
                                                    <div class="block-slideshow__slide-button"><span class="btn btn-primary btn-lg">Заполнить форму</span></div>
                                                </div>
                                            </a>
                                        </div>
                                    </div>
                ...
                <div class="block-features__list">
                    <div class="block-features__item">
                        ...
                        <div class="block-features__content">
                            ...
                            <div class="block-features__subtitle">Минимальная сумма заказа 2000р.</div>
                        </div>
                    </div>
                    ...
                    <div class="block-features__item">
                        ...
                        <div class="block-features__content">
                            <div class="block-features__title">Работаем 24/7</div>
                            <div class="block-features__subtitle">Оформить заказ можно в любое время</div>
                        </div>
                    </div>
                    <div class="block-features__divider"></div>
                    <div class="block-features__item">
                        ...
                        <div class="block-features__content">
                            <div class="block-features__title">100% качество</div>
                            <div class="block-features__subtitle">Гарантия от производителя</div>
                        </div>
                    </div>
                    <div class="block-features__divider"></div>
                    <div class="block-features__item">
                        ...
                        <div class="block-features__content">
                            <div class="block-features__title">Горячие предложения</div>
        ...
        <div class="block block-products block-products--layout--large-first">
            <div class="container">
                <div class="block-header">
                    <h3 class="block-header__title">Товары магазина NextShop</h3>
                    <div class="block-header__divider"></div>
                </div>
                <div class="block-products__body">
                    <div class="block-products__featured">
                        <div class="block-products__featured-item">
                            <ProductCardMini :product="feature"></ProductCardMini>
                        </div>
                    </div>
                    <div class="block-products__list">
                        <div v-for="product in main_products" class="block-products__list-item">
                            <div class="product-card">
                              <ProductCardMini :product="product"></ProductCardMini>
                            </div>
                        </div>
                    </div>
                </div>
...
<!--                        <div class="block-product-columns__column">
                    ...
                    <div class="col-4">
                        <div class="block-header">
                            <h3 class="block-header__title">Акции и предложения</h3>
                            <div class="block-header__divider"></div>
                        </div>
<!--                        <div class="block-product-columns__column">
                            <div class="block-product-columns__item">
